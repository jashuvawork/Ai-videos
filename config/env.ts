...
const envSchema = z.object({
  ...
  AI_TEXT_PROVIDER: z.string().default("studio"),
  AI_IMAGE_PROVIDER: z.string().default("studio"),
  AI_VIDEO_PROVIDER: z.string().default("studio"),
  AI_VOICE_PROVIDER: z.string().default("edge"),
  AI_MUSIC_PROVIDER: z.string().default("studio"),
