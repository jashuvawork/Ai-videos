...
export const ABSOLUTE_NEGATIVE_PROMPT =
  "text, captions, subtitles, title cards, chapter cards, typography, words, labels, presentation slides, colored backgrounds, colored gradient screens, blank screens, watermarks, fake logos, floating text, floating objects, teleportation, object morphing, object duplication, disappearing objects, impossible physics, unrealistic machinery, unrealistic robotic movement, distorted humans, extra fingers, deformed hands, distorted faces, CGI look, cartoon look, plastic-looking materials, fake factory, static scenes, meaningless shots, inconsistent product, inconsistent characters, inconsistent environment, excessive camera movement, impossible camera movement, artificial transitions, glowing effects, random visual changes, half CGI look, AI slideshow, stock montage, spinning transitions, objects flying into place, readable text on screens signs boxes walls clothing, film crew, camera operator, woman with camera, cinema camera on tripod, professional video camera in frame, behind the scenes, movie set, film studio, director on set, photographer posing, portrait of woman, fashion model, empty warehouse with only camera equipment";
